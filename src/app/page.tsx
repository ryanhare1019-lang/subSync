    ...
    <main className="min-h-screen bg-gray-950 flex flex-col">
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-6 py-20">
        ...
        <p className="text-gray-400 text-lg mt-6 max-w-xl leading-relaxed">
          SubSync tracks your streaming subscriptions in one place and uses AI to recommend
          what to watch, listen to, or read — based on your actual taste.
        </p>
        <div className="flex items-center gap-4 mt-10">
          <Link
            href="/signup"
            className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-xl font-medium text-base transition-all hover:scale-105"
          >
            Start for free
          </Link>
          <Link
            href="/login"
            className="text-gray-400 hover:text-white px-6 py-3 rounded-xl font-medium text-base transition-colors border border-gray-700 hover:border-gray-600"
          >
            Sign in
          </Link>
        </div>
          ...
          {[
            {
              ...
              desc: 'See all your subscriptions and total monthly spend in one dashboard.',
            },
            {
              icon: '✨',
              title: 'AI Recommendations',
              desc: 'Claude analyzes your taste profile and tells you exactly what to watch next.',
            },
            {
              icon: '💸',
              title: 'No Waste',
              desc: 'Know which services are worth keeping and which you never actually use.',
            },
          ].map(f => (
      ...
      <footer className="text-center py-6 text-gray-600 text-sm">
        Built with Claude AI · SubSync MVP
      </footer>
    </main>
  );
}
